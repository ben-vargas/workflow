...
<GettingStartedIntro framework="SvelteKit" />
...
Start by creating a new SvelteKit project. This command will create a new directory named `my-workflow-app` with a minimal setup and set up a SvelteKit project inside it.
