...
<Cards>
  <Card title="Streaming Updates from Tools" href="/guides/ai/streaming-updates-from-tools">
    Stream progress updates from tools to the UI while they're executing.
  </Card>
  <Card title="Resumable Streams" href="/guides/ai/resumable-streams">
    Enable clients to reconnect to interrupted streams without losing data.
  </Card>
  <Card title="Sleep, Suspense, and Scheduling" href="/guides/ai/sleep-and-delays">
    Add native sleep, suspense, and scheduling functionality to your Agent and workflow.
  </Card>
  <Card title="Human-in-the-Loop" href="/guides/ai/human-in-the-loop">
...
- [Defining Tools](/docs/ai/defining-tools) - Tool patterns and execute context
