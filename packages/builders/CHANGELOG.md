...
- [#3695](https://github.com/vercel/workflow/pull/3695) [`5a05f40`](https://github.com/vercel/workflow/commit/5a05f409aa23f528f214640295f389cabdcb5a9d) Thanks [@VaguelySerious](https://github.com/VaguelySerious)! - Honour `config.externalPackages` in the combined and webhook esbuild passes, so a step that reaches an optional peer dependency no longer fails the build.
