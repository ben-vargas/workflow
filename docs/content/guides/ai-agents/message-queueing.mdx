...
<Callout type="info">
If you just need basic multi-turn conversations where messages arrive between turns, see [Chat Session Modeling](/guides/ai-agents/chat-session-modeling). This guide covers the more advanced case of injecting messages *during* turns.
</Callout>
...
- [Chat Session Modeling](/guides/ai-agents/chat-session-modeling) - Single-turn vs multi-turn patterns
